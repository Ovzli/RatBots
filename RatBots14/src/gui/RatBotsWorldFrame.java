...
//        makeNewGridMenu();
    ...
    {
        JMenuItem item = new JMenuItem();
//        RatBot rb = (RatBot)c.newInstance();
...
//        rbMenu.add(makeMenuItem("menu.rats.dynamic", 
        ...
        new ActionListener()
        {
            ...
            {
                RatBotWorld rbworld = (RatBotWorld) world;
            
                try {
                    Object o = myClass.newInstance();
                    if (o instanceof RatBot) {
                        rbworld.add((RatBot) o);
...
////                rbworld.add(new SmartRat());
    ...
    private void makeMenus()
    {
        ...
        menu.add(makeMenuItem("menu.arena.blocks", new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                RatBotWorld aw = (RatBotWorld)world; 
...
//        }));
        ...
        //This menu will be full of the RatBots that can be put into the arena...
